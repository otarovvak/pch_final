...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      if (!token) {
        setNotification({ severity: "error", title: "Ошибка", message: "Токен не найден. Перенаправление на страницу входа." });
      ...
      try {
        ...
        setNotification({ severity: "error", title: "Ошибка", message: "Ошибка при получении профиля" });
      }
    };
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      setUser(editedUser);
      setIsEditing(false);
      setNotification({ severity: "success", title: "Успех", message: "Профиль успешно обновлен" });
    } catch (error) {
      setNotification({ severity: "error", title: "Ошибка", message: "Ошибка при обновлении профиля" });
    }
  };
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm("Вы уверены, что хотите удалить свой аккаунт?")) {
      try {
        ...
        setNotification({ severity: "error", title: "Ошибка", message: "Ошибка при удалении аккаунта" });
      }
    }
  };
      ...
      <div className="profile-details">
        <div className="form-group">
          <TextField
            ...
            disabled={!isEditing}
            error={!!errors.name} // Show error if any
